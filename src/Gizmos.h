...
public:
	...
	// Adds an Axis-Aligned Bounding-Box with optional transform for rotation.
	static void		addBlackAABBFilled(const glm::vec3& a_center, const glm::vec3& a_extents,
		const glm::vec4& a_fillColour, const glm::mat4* a_transform = nullptr);

	// Adds an Axis-Aligned Bounding-Box with optional transform for rotation.
	static void		addAABBFilledBorderless(const glm::vec3& a_center, const glm::vec3& a_extents,
		const glm::vec4& a_fillColour, const glm::mat4* a_transform = nullptr);
	...
	static void		addBlackSphereFilled(const glm::vec3& a_center, float a_radius, int a_rows, int a_columns, const glm::vec4& a_fillColour,
		const glm::mat4* a_transform = nullptr, float a_longMin = 0.f, float a_longMax = 360,
		float a_latMin = -90, float a_latMax = 90);
